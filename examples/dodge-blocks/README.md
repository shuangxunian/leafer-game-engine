...
- tooling panel 是否能显示 audio runtime manifest、channels 和 operation records
...
- 示例通过 `createHudTextBundle(...)` 创建 score、status、title 和 overlay prompt，保持 HUD 节点在 screen-space layer
