...
- Framework 复用能力
  ...
  - 已有 asset manifest、entity template、scene config、scene config validation 和 component schema registry，开始具备数据驱动内容管线基础。
